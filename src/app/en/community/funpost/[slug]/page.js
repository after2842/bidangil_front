  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex font-myfont text-xl">
        ...
        <button className=" px-4 mt-4 text-blue-500">Stories</button>
        <button
          className=" px-4 mt-4 hover:text-blue-500"
          onClick={() => {
            router.push("/en/form");
...
function HoldButton({ did_like, params, fetchCsrfToken, post }) {
  ...
  const handleClickProfile = () => {
    router.push(`/en/community/usrprofile?usr=${post?.user_nickname}`);
  };
            ...
            <div key={index}>
                ...
                >
                  <div className="flex flex-row justify-between items-center">
                    <p
                      ...
                      onClick={() =>
                        router.push(`/en/community/funpost/${mypost.slug}`)
                      }
                    >
                      {mypost.title}
                    </p>
              ...
              <div className="flex flex-row justify-end mb-4">
                ...
                {mypost.post_like.liked_avatars.length !== 0 ? (
                  <span className="text-xs flex items-center mr-2">Likes</span>
                ) : (
                  <>‎ </>
                )}
                  ...
                  <>
                    <button key={i}>
                      <img
                        ...
                        onClick={() =>
                          router.push(
                            `/en/community/usrprofile?usr=${mypost?.post_like?.liked_nickname[i]}`
                          )
                        }
                      ></img>
                    </button>
