    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex font-myfont text-xl">
        <button
          ...
          onClick={() => router.push("/en/community/review")}
        >
          Reviews
        </button>
        <button
          className=" px-4 mt-4 hover:text-blue-500"
          onClick={() => router.push("/en/community/funpost")}
        >
          Stories
        </button>
        <button
...
const EditProfile = ({
  ...
  const editProfileSubmit = async () => {
    ...
    if (verifiedNickname !== "ok" && nickname !== communityProfile.nickname) {
      alert("Please verify nickname availability");
      return;
    }
  ...
  const changeNickname = (e) => {
    ...
    if (e.length > 11) {
      alert("Nickname can be maximum 11 characters");
    } else {
      setnickname(e);
    }
  };
    ...
    <div>
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm">
        <div className="bg-white w-2/3 h-[70vh] p-8 rounded-xl shadow-xl">
          <h2 className="text-2xl mb-4 text-center font-myfont">
            My Character
          </h2>
          <div className="flex">
                          ...
                          {!verifyNicknameClicked ? (
                            ...
                            <>
                              {verifiedNickname === "ok" ? (
                                ...
                                <p className="text-black">In Use</p>
                              )}
                            </>
                          )}
                        </button>
                  ...
                  <div className="absolute top-[530px] w-[180px] max-h-48 overflow-y-auto flex flex-col space-y-1 ">
                    {communityProfile?.liked_users_avatar?.map((src, idx) => (
                      <div
                        ...
                        onClick={() =>
                          router.push(
                            `/en/community/usrprofile?usr=${communityProfile?.liked_users_nickname[idx]}`
                          )
                        }
                      >
                        {" "}
            ...
            <div className="w-full flex justify-end">
              <Link
                href="/en/community/createavatar"
                target="_blank"
    ...
    <div className=" rounded-xl flex flex-col items-start space-y-4 border shadow-md p-2">
      ...
      <div className="flex">
        ...
        <button
          ...
          onClick={() => {
            router.push("/en/community/writepost");
          }}
        >
          Write Post
        </button>
...
function CommunityLanding() {
  return (
    <main className="min-h-screen bg-white flex flex-col items-center pb-24">
      <h1 className="font-myfont text-4xl mt-16">Bidangil Community</h1>
      <p className="text-gray-500 mt-2">
        Reviews · Sharing · Stories – A space for everyone to enjoy together
      </p>
      ...
      >
        {/* ① Review Feed (large) */}
        <BentoCard
          href="/en/community/review?page=1"
          className="lg:col-span-2 lg:row-span-2"
          title="Fresh Reviews"
          subtitle="Real-time ratings & photos"
          gradient="from-orange-400 to-red-500"
        />

        {/* ② Sharing Feed (large) */}
        <BentoCard
          href="/en/community/share?page=1"
          className="lg:col-span-2 lg:row-span-1"
          title="Item Sharing"
          subtitle="Give what you don't need to those who do"
          gradient="from-blue-400 to-purple-500"
        />

        {/* ③ Fun Board (small) */}
        <BentoCard
          href="/en/community/funpost"
          className="lg:col-span-1 lg:row-span-1"
          title="Communication Board"
          subtitle="Casual chat & meetups"
          gradient="from-emerald-400 to-teal-500"
        />

        {/* ④ Write Post (small) */}
        <BentoCard
          href="/en/community/writepost"
          className="lg:col-span-1 lg:row-span-1 text-[15.5px]"
          title="Write Post"
          subtitle="Share your own story"
