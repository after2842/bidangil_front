  ...
  return (
    <div className="min-h-screen p- flex flex-col items-center justify-center">
      <div className="w-full max-w-7xl">
        <h1 className="text-5xl text-black mb-12 font-myfont font-bold text-left">
          Pricing
        </h1>
      </div>
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8">
        <CardDemo
          title="Service Fee"
          description="A 4% fee is added to the total product cost."
          cardType="pricing"
          primaryIcon="tag"
        />
        ...
        <CardDemo
          title="Exchange Rate"
          description="We use the exchange rate at the time you submit your request."
          cardType="currency"
          primaryCurrency="BTC"
        />
        ...
        <CardDemo
          title="Shipping Cost"
          description="Shipping is based on weight and volume. Use our calculator to get an estimate."
          cardType="delivery"
