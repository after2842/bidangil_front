...
export default function RequestFormEng({ forms, setforms }) {
            ...
            <div key={index}>
              ...
              <div className="w-full ">
                <h id={`option${index}`} className="text-black text-sm">
                  Options{" "}
                  <span className="text-[12px] ">(Quantity, Color, etc.)</span>
                </h>
                <div className="p-[0.1px] rounded-lg shadow-sm">
                  <InputOne
                    id={`desc-${index}`}
                    placeholder="Please enter options like quantity, color, etc."
                    type="text"
                    value={form.desc}
                    onChange={(e) =>
    ...
    <div>
      ...
      <div className="w-full mb-6">
        <h id="addressLine2" className="text-black text-sm">
          Options <span className="text-[12px] "></span>
        </h>
        <InputOne
          id="desc"
