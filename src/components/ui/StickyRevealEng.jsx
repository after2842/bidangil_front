          ...
          {contentTitle.map((item, index) => (
            <div key={item + index} className="my-[150px]">
              <motion.h2
                ...
                className="text-4xl font-bold font-arimo text-slate-100 whitespace-pre-line"
              >
                {item}
              </motion.h2>
              <motion.div
                ...
                <div className="space-y-1">
                  {descriptionbyline[index].map((line, i) => (
                    <RenderLine
                      ...
                      line={line}
                      highlight={[
                        "product link and your preferences",
                        "Once you pay, we place the order",
                        "final bill for the delivery",
